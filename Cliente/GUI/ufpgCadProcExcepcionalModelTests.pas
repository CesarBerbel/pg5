unit ufpgCadProcExcepcionalModelTests;
...
type
  ...
  TffpgCadProcExcepcionalModelTests = class(TfpgModelTests)
  private
  ...
  published
    ...
    property fpgVaga: string read FsVaga write FsVaga;
    property fpgCdFila: string read FsCdFila write FsCdFila;
...
procedure TffpgCadProcExcepcionalModelTests.CarregarModelTest(poCDS: TspClientDataSet);
begin
  inherited;
...
destructor TffpgCadProcExcepcionalModelTests.Destroy;
begin
...
class function TffpgCadProcExcepcionalModelTests.VerificarCadastroProcesso(
...
class function TffpgCadProcExcepcionalModelTests.VerificarArmasEBensCadastrado(
...
class function TffpgCadProcExcepcionalModelTests.VerificarOutrosNumerosObservacao(
...
class function TffpgCadProcExcepcionalModelTests.VerificarOutroAssunto(
  psAssunto, psFlPrincipal, psFlEtiqueta, psNuProcesso: string): boolean;
var
  osegRepositorio: TesegRepositorio;
  sSQL: string;
begin
...
class function TffpgCadProcExcepcionalModelTests.RetornarSiglaCliente: string;
var
  osegRepositorio: TesegRepositorio;
  sSQL: string;
begin
