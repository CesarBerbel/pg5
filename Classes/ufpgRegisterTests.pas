...
begin
  ...
  RegisterTest('Interface\Unificação Processo', TffpgCadUnificacaoTests.Suite);

  RegisterTest('Interface\Cadastro\Redistribuição entre Vagas', TffpgRedistribLoteVagaTests.Suite);
  RegisterTest('Interface\Cadastro\Cadastro de Precatórias', TffpgCadPrecatoriaTests.Suite);
  //Expediente
  ...
  //  RegisterTest('Interface\Andamento\Pauta de Audiências em Bloco',
  ...
  RegisterTest('Interface\Consulta\Consulta de Processo Básica', TffpgConsProcBasicaTests.Suite);
  RegisterTest('Interface\Consulta\Consulta de Registro de Sentença',
  ...
  RegisterTest('Interface\Relatórios\Processos\Relatório Analítico de Distribuição',
    TffpgRelAnaliticoDistribTests.Suite);
  RegisterTest('Interface\Relatórios\Processos\Histórico do Processo no Fluxo',
